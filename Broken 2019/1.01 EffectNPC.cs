	...
	public class EffectNPC : GameNPC
	{
		...
		public override bool Interact(GamePlayer player)
		{
			if(base.Interact(player))
			{
				...
				SendReply(player, 	"Greetings Traveller!\n\n"+
				          			"I can either change the effect, the color and even the speed of your weapons, armors...\n"+
		...
		public override bool ReceiveItem(GameLiving source, InventoryItem item)
		{
			...
			SendReply(t, "What service do you want to use ?\n"+
			          	"Shall i change the [speed] of your weapon,"+
			          	" shall i add an [effect] to it or do you want me to [dye] it ?.");
		...
		public void SetSpeed(GamePlayer player, int speed)
		{
			...
			if(speed > 45 && item.Hand != 1 && item.Object_Type != 10 && item.Object_Type != 10 && item.Object_Type != 9
